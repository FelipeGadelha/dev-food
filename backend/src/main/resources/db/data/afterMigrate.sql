...
INSERT INTO products (id, name, description, price, active, image_link, category_id) VALUES
(1, 'Coxinha', 'coxinha de frango', 50.0, true, 'https://i.ibb.co/qYYKHN3/coxinha-1030446680-612x612.jpg', 1),
(2, 'Porco com molho agridoce', 'Deliciosa carne suína ao molho especial', 78.90, false, 'https://i.ibb.co/T0jP8ry/porco-agridoce.jpg', 1),
(3, 'Camarão tailandês', '16 camarões grandes ao molho picante', 110, true, 'https://i.ibb.co/pjPxSqd/camaraothai.webp', 2),
(4, 'Salada picante com carne grelhada', 'Salada de folhas com cortes finos de carne bovina grelhada e nosso molho especial de pimenta vermelha', 87.20, true, 'https://i.ibb.co/vmJJvbp/salada-grelhada-quente-e-picante-da-carne-de-porco-receita-tailandesa-da-salada-da-carne-tradicional.webp', 1),
(5, 'Garlic Naan', 'Pão tradicional indiano com cobertura de alho', 21, true, 'https://i.ibb.co/JCK7P90/Garlic-Naan.webp', 1),
(6, 'Murg Curry', 'Cubos de frango preparados com molho curry e especiarias', 43, true, 'https://i.ibb.co/pR56pbh/Murg-Curry.jpg', 1),
(7, 'Bife Ancho', 'Corte macio e suculento, com dois dedos de espessura, retirado da parte dianteira do contrafilé', 79, true, 'https://i.ibb.co/jRqyMN1/bife-ancho.jpg', 1),
(8, 'T-Bone', 'Corte muito saboroso, com um osso em formato de T, sendo de um lado o contrafilé e do outro o filé mignon', 89, true, 'https://i.ibb.co/q7S9shW/T-Bone.jpg', 1),
(9, 'Sanduíche X-Tudo', 'Sandubão com muito queijo, hamburger bovino, bacon, ovo, salada e maionese', 19, true, 'https://i.ibb.co/rmHdhKF/Sanduiche-X-Tudo.jpg', 1),
(10, 'Espetinho de Cupim', 'Acompanha farinha, mandioca e vinagrete', 8, true, 'https://i.ibb.co/LvCFPSx/Espetinho-de-Cupim.jpg', 1);
